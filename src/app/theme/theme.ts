...
export const cssVariablesResolver: CSSVariablesResolver = (t) => ({
  ...
  light: {
    ...
    '--app-hero-gradient':
      'radial-gradient(1200px 600px at 0% 0%, rgba(99,102,241,.10), transparent 60%), radial-gradient(800px 400px at 100% 100%, rgba(52,211,153,.10), transparent 60%)',
  ...
  dark: {
    ...
    '--app-hero-gradient':
      'radial-gradient(1200px 600px at 0% -10%, rgba(99,102,241,.22), transparent 60%), radial-gradient(800px 400px at 110% 110%, rgba(168,85,247,.18), transparent 60%)',
